      ...
      <div class="mt-2 flex flex-row">
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            variant="link"
            @click="
              openWindow('https://gitee.com/litchicode/litchi-ui-admin-vben')
            "
          >
            Gitee
          </VbenButton>
          <VbenButton
            variant="link"
            @click="
              openWindow('https://github.com/litchicode/litchi-ui-admin-vben')
            "
          >
            Github
          </VbenButton>
        ...
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            ...
            @click="
              openWindow(
                'https://gitee.com/litchicode/litchi-ui-admin-vben/issues',
              )
            "
          >
            Gitee
          ...
          <VbenButton
            ...
            @click="
              openWindow(
                'https://github.com/litchicode/litchi-ui-admin-vben/issues',
              )
            "
          >
            Github
