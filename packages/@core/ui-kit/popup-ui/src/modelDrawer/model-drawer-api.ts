import type { ModelDrawerApiOptions, ModelDrawerState } from './model-drawer';

import { Store } from '@vben-core/shared/store';
import { bindMethods, isFunction } from '@vben-core/shared/utils';

export class ModelDrawerApi {
  // 共享数据
  public sharedData: Record<'payload', any> = {
    payload: {},
  };
  public store: Store<ModelDrawerState>;
  ...
  private state!: ModelDrawerState;

  constructor(options: ModelDrawerApiOptions = {}) {
    const {
    ...
    const defaultState: ModelDrawerState = {
      bordered: false,
      cancelText: '',
      centered: false,
      class: '',
    ...
    this.store = new Store<ModelDrawerState>(
      {
        ...defaultState,
        ...storeState,
      },
